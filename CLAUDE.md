...
- **testomniac_types** — Shared type definitions; this project imports all API types (`History`, request/response types, `BaseResponse`)
...
- **testomniac_app_rn** — React Native app that uses this client via file: links
